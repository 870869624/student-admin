<template>
  <a-card title="专利列表" style="max-width: 1200px; margin: 5px auto">
    <!-- 搜索框区域 -->
    <a-form layout="inline" style="margin-bottom: 20px">
      <a-form-item label="专利名称">
        <a-input v-model:value="pageRequest.name" placeholder="请输入专利名称" style="width: 200px" />
      </a-form-item>
      ...
      <a-form-item label="专利描述">
        <a-input v-model:value="pageRequest.description" placeholder="请输入专利描述" style="width: 200px" />
      </a-form-item>

      <a-form-item label="专利批次">
        <a-input v-model:value="pageRequest.batch" placeholder="请输入专利批次" style="width: 200px" />
      </a-form-item>

      <a-form-item style="margin-top: 10px" label="专利来源">
        <a-input v-model:value="pageRequest.source" placeholder="请输入专利来源" style="width: 200px" />
      </a-form-item>

      <a-form-item label="专利状态" style="margin-top: 10px">
    ...
    <a-table :data-source="projects" :pagination="false" row-key="id" bordered size="middle" :loading="loading">
      <a-table-column title="专利名称" data-index="name" key="name" />
