<template>
    ...
    >
      ...
      <a-table-column title="操作" key="action">
        <template #default="{ record }">
          ...
          <a-button style="margin-left: 2px" danger @click="handleDown(record)"
            >项目驳回
          </a-button>
          <a-button
  ...
  >
    ...
    <a-form-item label="延期结束日期" name="approval_date">
      <a-date-picker
        v-model:value="formDate.approval_date"
        style="width: 100%"
      />
    </a-form-item>
  </a-modal>
  <a-modal
    v-model:visible="isDownModalVisible"
    title="项目延期"
    @ok="handleDownProject"
  >
