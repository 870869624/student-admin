<template>
  <a-card :bordered="false" title="项目申报" style="background-color: #f4f4f4;">
    <div class="container">
      <h1 class="page-title">申报项目</h1>
      <a-form @submit="handleSubmit" layout="vertical">
        ...
        <a-row>
          <a-col :span="11">
            ...
            <a-form-item label="开始日期" name="start_date">
              <a-date-picker v-model:value="formDate.start_date" style="width: 100%" />
            </a-form-item>
          </a-col>
          <a-col :span="11" :offset="2">
            <!-- 预计结束日期 -->
            <a-form-item label="预计结束日期" name="expected_endDate">
              <a-date-picker v-model:value="formDate.expected_end_date" style="width: 100%" />
            </a-form-item>
          </a-col>
        </a-row>
        ...
        <a-row>
          <a-col :span="11">
            ...
            <a-form-item label="导师" name="teacher_id">
              <a-select v-model:value="form.teacher_id" placeholder="请选择导师" style="width: 100%">
          ...
          <a-col :span="11" :offset="2">
            ...
            <a-form-item label="参与者" name="participant">
              <a-select mode="multiple" v-model:value="form.participant" placeholder="请选择参与者" style="width: 100%">
        ...
        <a-row>
          ...
          <a-col :span="11" :offset="2">
            ...
            <a-form-item label="结果类型" name="result_type">
              <a-select v-model:value="form.result_type" placeholder="请选择项目类型" style="width: 100%">
        ...
        <a-form-item label="上传文件" name="file_path">
          <a-upload v-model:value="form.file_path" :custom-request="handleCustomUpload" :show-upload-list="true">
            <a-button icon="">
              <UploadOutlined />
              文件上传
            </a-button>
