    ...
    >
      ...
      <a-table-column title="操作" key="action">
        <template #default="{ record }">
          ...
          >
            <a-button type="link" style="margin-left: 3px"
              >查看驳回原因
            </a-button>
          </a-tooltip>
        </template>
  ...
  >
    <a-form layout="vertical">
      ...
      <a-form-item label="导师" name="teacher_id">
        <a-select
          v-model:value="updateForm.teacher_id"
          placeholder="请选择导师"
          style="width: 100%"
        >
          <a-select-option
      ...
      <a-row gutter="16">
        <a-col :span="12">
          <a-form-item label="批次" name="batch">
            <a-input
              v-model:value="updateForm.batch"
              placeholder="请输入批次"
            />
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label="来源" name="source">
            <a-input
              v-model:value="updateForm.source"
              placeholder="请输入来源"
            />
          </a-form-item>
        </a-col>
      ...
      <a-row gutter="16">
        <a-col :span="12">
          <a-form-item label="上传文件" name="file_path">
            <a-upload
              v-model:value="updateForm.file_path"
        ...
        <a-col :span="12">
          <a-form-item label="参与者" name="participant">
            <a-select
              mode="multiple"
              v-model:value="updateForm.participant"
              placeholder="请选择参与者"
              style="width: 100%"
            >
              <a-select-option
      ...
      <a-form-item label="结果类型" name="result_type">
        <a-select
          v-model:value="updateForm.result_type"
          placeholder="请选择项目类型"
          style="width: 100%"
        >
